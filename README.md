...
```json
"extends": ["github>arrrgi-labs/renovate-config"]
```
...
#### Group Python - `github>arrrgi-labs/renovate-config//presets/groupPython`

This preset groups Python version updates together (non-breaking updates only)
across the supported managers:
...
Use this when you want Renovate to open a single PR for coordinated Python
runtime/tooling version bumps.

#### Regex Manager - `github>arrrgi-labs/renovate-config//presets/regexManager`
